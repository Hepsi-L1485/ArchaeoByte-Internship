...
l1=['back_pain','constipation','abdominal_pain','itching','nodal_skin_eruptions','headache','chills','cough','diarrhoea','stomach_pain','skin_rash','mild_fever','yellow_urine',
...
def check_patient_name():
    ...
    if not Name.get():
        messagebox.showinfo("Error", "Please enter the patient's name.")
        return False
    return True

def DecisionTree():
    if not check_patient_name():
        return
...
# Heading
w2 = Label(root, justify=LEFT, text="Disease Predictor using Machine Learning", fg="black", bg="skyblue")
w2.config(font=("Elephant", 30))
w2.grid(row=1, column=0, columnspan=2, padx=100)
w2 = Label(root, justify=LEFT,fg="white", bg="skyblue")
...
# Use ttk.Combobox instead of OptionMenu for scrolling
